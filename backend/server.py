...
# ACTIVITIES
@api_router.post("/activities/manual", response_model=Activity, dependencies=[Depends(guardrails_content_check)])
...
# JOURNALS
@api_router.post("/journals", response_model=Journal, dependencies=[Depends(guardrails_content_check)])
...
@api_router.put("/journals/{journal_id}", response_model=Journal, dependencies=[Depends(guardrails_content_check)])
